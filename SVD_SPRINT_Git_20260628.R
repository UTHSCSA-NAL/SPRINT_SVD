...
# Measurement model for svd in time 1
 svd_1 =~ 1*r_pvwml.0 + fw.1*r_fw.0 + bg.1*r_bgepvsc.0

# Measurement model for svd in time 2
 svd_2 =~ 1*r_pvwml.1 + fw.2*r_fw.1 + bg.2*r_bgepvsc.1
...
model2 <-paste0('
# Measurement model for svd in time 1
 svd_1 =~ 1*r_pvwml.0 + fw*r_fw.0 + bg*r_bgepvsc.0

# Measurement model for svd in time 2
 svd_2 =~ 1*r_pvwml.1 + fw*r_fw.1 + bg*r_bgepvsc.1
...
model4 <-paste0('
# Measurement model for svd in time 1
 svd_1 =~ 1*r_pvwmln.0 + fw.1*r_fw.0 + bg.1*r_bgepvscn.0

# Measurement model for svd in time 2
 svd_2 =~ 1*r_pvwmln.1 + fw.2*r_fw.1 + bg.2*r_bgepvscn.1

# Mean structure specification
r_pvwmln.0 ~ ipv.1*1
r_fw.0 ~ ifw.1*1
r_bgepvscn.0 ~ ibg.1*1
r_pvwmln.1 ~ ipv.2*1
r_fw.1 ~ ifw.2*1
r_bgepvscn.1 ~ ibg.2*1
...
model5 <-paste0('
# Measurement model for svd in time 1
 svd_1 =~ 1*r_pvwmln.0 + fw*r_fw.0 + bg*r_bgepvscn.0

# Measurement model for svd in time 2
 svd_2 =~ 1*r_pvwmln.1 + fw*r_fw.1 + bg*r_bgepvscn.1
...
plt$layout[1, ] <- c(-1, 0.6) #p.1
plt$layout[2, ] <- c(-0.7, 0.6) #f.1
plt$layout[3, ] <- c(-0.4, 0.6) #b.1
plt$layout[4, ] <- c(0.2, 0.6) #p.2
plt$layout[6, ] <- c(0.5, 0.6) #f.2
plt$layout[7, ] <- c(0.8, 0.6) #b.2
plt$layout[5, ] <- c(-1.3, -0.2) #age.c.0
plt$layout[8, ] <- c(-0.1, -0.2) #dufu
plt$layout[9, ] <- c(-0.7, -0.8) #s_1
plt$layout[10, ] <- c(0.5, -0.8) #s_2
...
plt$layout[5, ] <- c(0.5, 0.6) #f.2
plt$layout[6, ] <- c(0.2, 0.6) #p.2
plt$layout[7, ] <- c(0.8, 0.6) #b.2
plt$layout[8, ] <- c(-0.1, -0.2) #dufu
plt$layout[9, ] <- c(-0.7, -0.8) #s_1
plt$layout[10, ] <- c(0.5, -0.8) #s_2
...
plt$layout[3, ] <- c(-0.4, 0.6) #b.1
plt$layout[4, ] <- c(-1.3, -0.2) #age.c.0
plt$layout[5, ] <- c(0.2, 0.6) #p.2
plt$layout[6, ] <- c(0.8, 0.6) #b.2
plt$layout[7, ] <- c(0.5, 0.6) #f.2
plt$layout[8, ] <- c(-0.1, -0.2) #dufu
plt$layout[9, ] <- c(-0.7, -0.8) #s_1
plt$layout[10, ] <- c(0.5, -0.8) #s_2
...
pl_par <- pl_par[!rownames(pl_par) %in% rownames(pl_par[pl_par$edge == "int" & !pl_par$rhs %in% c("dC", "svd_1"), ]), ]
...
plt$layout[10, ] <- c(-0.7, -0.5) #s_1
plt$layout[11, ] <- c(0.5, -0.5) #s_2
plt$layout[12, ] <- c(-0.2, -1) #dC
plt$layout[13, ] <- c(-1.2, -0.5) #int.s_1
...
# Latent variable mean structure
svd_1 ~ a0*1 + age.c.0 + female + r_icv.0 + ', paste(c(race), collapse = " + "), '
svd_2 ~ 0*1
...
plt$layout[12, ] <- c(-0.7, -0.5) #s_1
plt$layout[13, ] <- c(0.5, -0.5) #s_2
plt$layout[14, ] <- c(-0.2, -1) #dC
plt$layout[15, ] <- c(-1.2, -0.5) #int.s_1
...
plt$layout[11, ] <- c(-0.7, -0.5) #s_1
plt$layout[12, ] <- c(0.5, -0.5) #s_2
plt$layout[13, ] <- c(-0.2, -1) #dC
plt$layout[14, ] <- c(-1.2, -0.5) #int.s_1
...
fit6_boot <- lavaan::sem(model6, data = wide01, estimator = "ML", test = "yuan.bentler.mplus",
                         se = "bootstrap", bootstrap = 5317, parallel = "snow",
